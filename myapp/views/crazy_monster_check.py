...
def check_equip(equip_datas):
    ...
    if new_data[0] == Mount_data:
        ...
        # print(content)
        # execute_sql(sid=4, channel_id=6, content=content[0], name=content[1], record_pag_url=new_data[7],
